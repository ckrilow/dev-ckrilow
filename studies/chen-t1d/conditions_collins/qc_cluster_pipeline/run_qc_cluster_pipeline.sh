...
export STUDY_DIR="/cluster/ifs/projects/collins/taylorhj/projects/sc_nextflow/studies/chen-t1d/conditions_collins/qc_cluster_pipeline"
...
/home/taylorhj/miniconda3/envs/nextflow20/bin/nextflow run \
    "${REPO_MODULE}/main.nf" \
     ...
     --file_paths_10x "${STUDY_DIR}/../epoch_1000_lr_1.0E-4.tsv" \
