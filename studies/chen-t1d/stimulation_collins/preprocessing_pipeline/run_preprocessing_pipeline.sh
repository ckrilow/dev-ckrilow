...
export STUDY_DIR="/cluster/ifs/projects/collins/taylorhj/projects/sc_nextflow/studies/chen-t1d/stimulation_collins/preprocessing_pipeline"
export OUTPUT_DIR="${STUDY_DIR}/results/nf-preprocessing"
#export OUTPUT_DIR="${STUDY_DIR}/results/nf-preprocessing_test"
