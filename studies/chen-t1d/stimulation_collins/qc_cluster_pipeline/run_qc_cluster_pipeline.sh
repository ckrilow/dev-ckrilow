...
export STUDY_DIR="/cluster/ifs/projects/collins/taylorhj/projects/sc_nextflow/studies/chen-t1d/stimulation_collins/qc_cluster_pipeline"
export OUTPUT_DIR="${STUDY_DIR}/results/min_parameter_sweep"
# export OUTPUT_DIR="${STUDY_DIR}/results/nf-sample_qc=cellbender_parker_singlet-parameter_sweep_v001_harmony"
...
/home/taylorhj/miniconda3/envs/nextflow20/bin/nextflow run \
    "${REPO_MODULE}/main.nf" \
     ...
     --file_sample_qc "${STUDY_DIR}/params-sample_qc-doublets_mito0pt12_umi_5k_30k.yml" \
